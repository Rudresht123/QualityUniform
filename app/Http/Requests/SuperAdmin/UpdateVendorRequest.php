...
class UpdateVendorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $vendorId = $vendor instanceof \App\Models\SuperAdmin\Vendor ? $vendor->vendor_id : $vendor;
        ...
        return [
            'business_name' => [
                ...
                'string',
                'max:150',
                Rule::unique('vendors', 'business_name')->ignore($vendorId, 'vendor_id'),
            ],
            'owner_name' => [
                'required',
                'string',
            ...
            'email' => [
                ...
                'email:rfc,dns',
                'max:150',
                Rule::unique('vendors', 'email')->ignore($vendorId, 'vendor_id'),
            ],
            'phone' => [
                'required',
                'regex:/^[0-9\s\-\+\(\)]{10,15}$/',
    ...
    public function messages(): array
    {
        return [
            ...
            'business_name.unique' => 'This business name is already registered with another vendor.',
