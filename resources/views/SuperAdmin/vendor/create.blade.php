                                ...
                                <div class="row">
                                    <div class="col-md-6 fonts">
                                        ...
                                        <input type="text" name="business_name" class="form-control @error('business_name') is-invalid @enderror"
                                            placeholder="Enter business / shop name" value="{{ old('business_name') }}" required>
                            ...
                            <fieldset class="form-section">
                                ...
                                <div class="row">
                                    <div class="col-md-12 fonts">
                                        ...
                                        <textarea rows="3" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Enter complete address" required>{{ old('address') }}</textarea>
                            ...
                            <fieldset class="form-section">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 fonts">
                                        ...
                                        <input type="text" name="commission_rate" class="form-control @error('commission_rate') is-invalid @enderror"
